...
var format_rios_princ_3 = new ol.format.GeoJSON();
var features_rios_princ_3 = format_rios_princ_3.readFeatures(json_rios_princ_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_rios_princ_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_rios_princ_3.addFeatures(features_rios_princ_3);
var lyr_rios_princ_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_rios_princ_3, 
                style: style_rios_princ_3,
                popuplayertitle: "rios_princ",
                interactive: true,
                title: '<img src="styles/legend/rios_princ_3.png" /> rios_princ'
            });
var format_LineasSismicas_4 = new ol.format.GeoJSON();
var features_LineasSismicas_4 = format_LineasSismicas_4.readFeatures(json_LineasSismicas_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LineasSismicas_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LineasSismicas_4.addFeatures(features_LineasSismicas_4);
var lyr_LineasSismicas_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_LineasSismicas_4, 
                style: style_LineasSismicas_4,
                popuplayertitle: "LineasSismicas",
                interactive: true,
                title: '<img src="styles/legend/LineasSismicas_4.png" /> LineasSismicas'
            });
var format_pozos_5 = new ol.format.GeoJSON();
var features_pozos_5 = format_pozos_5.readFeatures(json_pozos_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pozos_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_pozos_5.addFeatures(features_pozos_5);
var lyr_pozos_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_pozos_5, 
                style: style_pozos_5,
                popuplayertitle: "pozos",
                interactive: true,
                title: '<img src="styles/legend/pozos_5.png" /> pozos'
            });

lyr_Sat_0.setVisible(true);lyr_Bloques_1.setVisible(true);lyr_mun_2.setVisible(true);lyr_rios_princ_3.setVisible(true);lyr_LineasSismicas_4.setVisible(true);lyr_pozos_5.setVisible(true);
var layersList = [lyr_Sat_0,lyr_Bloques_1,lyr_mun_2,lyr_rios_princ_3,lyr_LineasSismicas_4,lyr_pozos_5];
